                    ...
                    <div class="container-fluid">
                        <form method="post" action='<c:url value="/addStudent/${student.id}"/>'>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 mb-12">
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                ...
                                                <div class="form-group row">
                                                    <label сlass="col-2 col-form-label">Od czego się zaczęło:</label>
                                                    <div class="col-10">
                                                ...
                                                <div class="form-group row">
                                                    <label lass="col-2 col-form-label">Czy kursant opanował
                                                        jakieś technologie ?</label>
                                                    <div class="col-1">
                                                        <label class="radio-inline"><input type="radio" name="checkBox" value="1" <c:if test="${student.checkBox eq '1'}">checked</c:if>>TAK</label>
                                                    </div>
                                                    <div class="col-1">
                                                        <label class="radio-inline"><input type="radio" name="checkBox" value="0" <c:if test="${student.checkBox eq '0'}">checked</c:if>>NIE</label>
                                                    </div>
                                                </div>
                                    ...
                                    <c:if test="${student.checkBox eq '1'}">
                                            ...
                                            <div class="card-header py-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        ...
                                                        <input class="form-control" type="text" name="java" value="${student.java}">
                                                    </div>


                                                    <div class="col-2">
                                                        <label class="col-form-label">Wzorce projektowe</label>
                                                        <input class="form-control" type="text" name="bestPractice" value="${student.bestPractice}">
                                                    </div>


                                                    <div class="col-2">
                                                        <label class="col-form-label">TDD</label>
                                                        <input class="form-control" type="text" name="tdd" value="${student.tdd}">
                                                    </div>


                                                    <div class="col-2">
                                                        <label class="col-form-label">Bazy danych SQL</label>
                                                        <input class="form-control" type="text" name="question" value="${student.question}">
                                                    </div>
                                                    ...
                                                    <div class="col-2">
                                                        ...
                                                        <input class="form-control" type="text" name="hibernate" value="${student.hibernate}">
                                                    </div>


                                                    <div class="col-2">
                                                        <label class="col-form-label">HTML_CSS</label>
                                                        <input class="form-control" type="text" name="html" value="${student.html}">
                                                    </div>


                                                    <div class="col-2">
                                                        <label class="col-form-label">JSP</label>
                                                        <input class="form-control" type="text" name="jsp" value="${student.jsp}">
                                                    </div>

                                                    <div class="col-2">
                                                        <label class="col-form-label">Thymeleaf</label>
                                                        <input class="form-control" type="text" name="thymeleaf" value="${student.thymeleaf}">
                                                    </div>

                                                    <div class="col-2">
                                                        <label class="col-form-label">git</label>
                                                        <input class="form-control" type="text" name="git" value="${student.git}">
                                                    </div>
