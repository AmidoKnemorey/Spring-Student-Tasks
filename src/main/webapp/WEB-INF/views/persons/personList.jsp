        ...
        <div id="content">
                            ...
                            <table class="table action-panel table-bordered" id="dataTable" cellspacing="0">
                                ...
                                <c:forEach items="${student}" var="title">
                                    <tr>
                                        ...
                                        <td><a href="${title.gitHub}" class="btn btn-info btn-circle">
                                            <i class="fas fa-info-circle"></i>
                                        </a></td>
                                        <td>${title.start}</td>
                                        <td>
                                            <a href="#" role="button" class="btn btn-success btn-circle"
                                               data-toggle="modal" data-target="#umiejetnosci">
                                        ...
                                        <td>
                                            <a href='<c:url value="/editStudents/${title.id}"/>'
           ...
           btn-danger pull-left"
            ...
            <div class="card-header py-3">
                ...
                <a href='<c:url value="addStudents"/>' class="btn btn-info btn-icon-split">
