...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-4 py-3 border-left-primary">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Dominik
                                        Maciąg
                                        | <strong>Dodano:</strong> 2020-07-09 | <strong>Deadline:</strong> 2020-07-09
                                    </div>
                                    Treść taska jakaś dłuższa nie musi być krótka jako Lorem ipsum to pisze aby
                                    sprawdzić jak
                                    będzie wyglądać
                                </div>
                            </div>
            ...
            <%--        The libe above instead of lines below--%>
